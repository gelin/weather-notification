...
@Deprecated
public class ParcelableWeather_v_0_2 extends SimpleWeather implements Parcelable {

    public ParcelableWeather_v_0_2() {
    }
    ...
    public static final Parcelable.Creator<ParcelableWeather_v_0_2> CREATOR = 
            new Parcelable.Creator<ParcelableWeather_v_0_2>() {
        public ParcelableWeather_v_0_2 createFromParcel(Parcel in) {
            return new ParcelableWeather_v_0_2(in);
        }
        public ParcelableWeather_v_0_2[] newArray(int size) {
            return new ParcelableWeather_v_0_2[size];
        }
    };
